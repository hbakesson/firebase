    ...
    <section className="card">
      ...
      <form ref={formRef} action={handleSubmit} className="form-grid">
        ...
        <div className="form-group" style={{ gridColumn: "span 2" }}>
          ...
          <textarea id="description" name="description" placeholder="Short description..." style={{ minHeight: "80px" }} />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="number" id="priority" name="priority" min="1" max="5" defaultValue="1" />
        </div>
        <div className="form-group">
          <label htmlFor="progress">Progress (%)</label>
          <input type="number" id="progress" name="progress" min="0" max="100" defaultValue="0" />
        </div>
